...
## Code & Highlighting
Booyaka supports syntax highlighting for code blocks in your markdown files. Check the [Code & Highlighting](/content/code-highlighting) section for configuration options related to code highlighting.

## Inline Editor
<div class="alert alert-info rounded-4">
  <div class="alert-content">There is a roadmap item to add an inline editor for editing markdown files directly within the documentation site. This feature is not yet implemented.</div>
</div>
